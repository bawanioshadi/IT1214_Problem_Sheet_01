 class Student {
    ...
    public Student(String name, int exam1, int exam2, int exam3) throws IllegalArgumentException {
    ...
    public static void main(String[] args) {
        try {
            ...
            System.out.println("Student: " + student.getName()+ student.calculateAverage());
